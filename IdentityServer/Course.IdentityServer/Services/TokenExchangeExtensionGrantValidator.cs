...
namespace Course.IdentityServer.Services
{
    public class TokenExchangeExtensionGrantValidator : IExtensionGrantValidator
    {
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            var tokenValidate = await _tokenValidator.ValidateAccessTokenAsync(token);
            ...
            var subjectClaim = tokenValidate.Claims.FirstOrDefault(x => x.Type == "sub");
            ...
            context.Result = new GrantValidationResult(subjectClaim.Value, "access_token", tokenValidate.Claims);
            return;
